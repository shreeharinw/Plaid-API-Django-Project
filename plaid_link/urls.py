...
urlpatterns = [
    ...
    path('api/get_DB_transactions/', views_api.get_DB_transactions.as_view(), name='get_DB_transactions'),
    path('api/get_DB_accounts/', views_api.get_DB_accounts.as_view(), name='get_DB_accounts'),
    ...
    path('api/accounts/', views_api.get_account_info.as_view(), name='get_account_info'),
